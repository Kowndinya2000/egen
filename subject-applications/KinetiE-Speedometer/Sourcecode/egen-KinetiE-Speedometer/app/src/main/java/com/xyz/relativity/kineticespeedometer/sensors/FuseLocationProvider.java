...
//			gpsLoggingInterval = returnLevel();
			locationManager.requestLocationUpdates(providerStr, returnLevel(parent.getApplicationContext()),
					MINIMUM_DISTANCE_METERS, FuseLocationProvider.this);
			Log.d(TAG, "========onResume: "+returnLevel(parent.getApplicationContext()));
		}
	}
