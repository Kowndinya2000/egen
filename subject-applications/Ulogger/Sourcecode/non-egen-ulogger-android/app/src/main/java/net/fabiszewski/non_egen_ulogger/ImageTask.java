...
import static net.fabiszewski.non_egen_ulogger.ImageHelper.clearImageCache;
import static net.fabiszewski.non_egen_ulogger.ImageHelper.getPersistablePermission;
import static net.fabiszewski.non_egen_ulogger.ImageHelper.getResampledBitmap;
import static net.fabiszewski.non_egen_ulogger.ImageHelper.getThumbnail;
import static net.fabiszewski.non_egen_ulogger.ImageHelper.saveToCache;
