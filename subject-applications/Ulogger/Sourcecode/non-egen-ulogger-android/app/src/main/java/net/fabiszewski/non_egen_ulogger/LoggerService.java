...
import static net.fabiszewski.non_egen_ulogger.LoggerTask.E_DISABLED;
import static net.fabiszewski.non_egen_ulogger.LoggerTask.E_PERMISSION;
import static net.fabiszewski.non_egen_ulogger.MainActivity.UPDATED_PREFS;
