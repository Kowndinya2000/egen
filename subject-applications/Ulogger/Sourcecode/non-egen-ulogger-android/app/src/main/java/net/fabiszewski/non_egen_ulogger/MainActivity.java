...
import static net.fabiszewski.non_egen_ulogger.Alert.showAlert;
import static net.fabiszewski.non_egen_ulogger.Alert.showConfirm;
import static net.fabiszewski.non_egen_ulogger.GpxExportService.GPX_EXTENSION;
import static net.fabiszewski.non_egen_ulogger.GpxExportService.GPX_MIME;
