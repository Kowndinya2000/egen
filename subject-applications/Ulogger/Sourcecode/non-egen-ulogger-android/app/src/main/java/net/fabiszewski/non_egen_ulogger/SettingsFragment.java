...
import static net.fabiszewski.non_egen_ulogger.SettingsActivity.KEY_ALLOW_EXTERNAL;
import static net.fabiszewski.non_egen_ulogger.SettingsActivity.KEY_AUTO_NAME;
import static net.fabiszewski.non_egen_ulogger.SettingsActivity.KEY_AUTO_START;
import static net.fabiszewski.non_egen_ulogger.SettingsActivity.KEY_HOST;
import static net.fabiszewski.non_egen_ulogger.SettingsActivity.KEY_LIVE_SYNC;
import static net.fabiszewski.non_egen_ulogger.SettingsActivity.KEY_PASS;
import static net.fabiszewski.non_egen_ulogger.SettingsActivity.KEY_PROVIDER;
import static net.fabiszewski.non_egen_ulogger.SettingsActivity.KEY_USERNAME;
