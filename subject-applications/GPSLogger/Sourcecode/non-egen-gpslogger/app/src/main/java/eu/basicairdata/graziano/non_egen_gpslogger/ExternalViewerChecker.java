...
import static eu.basicairdata.graziano.non_egen_gpslogger.GPSApplication.FILE_EMPTY_GPX;
import static eu.basicairdata.graziano.non_egen_gpslogger.GPSApplication.FILE_EMPTY_KML;
import static eu.basicairdata.graziano.non_egen_gpslogger.GPSApplication.FILETYPE_KML;
import static eu.basicairdata.graziano.non_egen_gpslogger.GPSApplication.FILETYPE_GPX;
...
//        fileTypeList.add(new FileType(gpxList, "application/gpx+xml", FILETYPE_GPX));
        ...
        for (FileType ft : fileTypeList) {
            ...
            Uri uri = FileProvider.getUriForFile(GPSApplication.getInstance(), "eu.basicairdata.graziano.non_egen_gpslogger.fileprovider", file);
