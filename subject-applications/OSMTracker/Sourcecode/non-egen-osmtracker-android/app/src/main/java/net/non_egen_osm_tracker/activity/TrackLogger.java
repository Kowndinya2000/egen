...
import net.non_egen_osm_tracker.listener.SensorListener;
import net.non_egen_osm_tracker.listener.PressureListener;
import net.non_egen_osm_tracker.receiver.MediaButtonReceiver;
import net.non_egen_osm_tracker.service.gps.GPSLogger;
import net.non_egen_osm_tracker.service.gps.GPSLoggerServiceConnection;
import net.non_egen_osm_tracker.util.CustomLayoutsUtils;
import net.non_egen_osm_tracker.util.FileSystemUtils;
import net.non_egen_osm_tracker.util.ThemeValidator;
import net.non_egen_osm_tracker.view.TextNoteDialog;
import net.non_egen_osm_tracker.view.VoiceRecDialog;
