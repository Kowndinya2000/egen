...
//	@Kowndinya
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setTitle("(eGEN) Track: " + currentTrackId + " D: 0mts" );
		initial = false;
...
//	}
	...
	private void updateUI(double latitude2, double longitude2) {
		...
		total_distance = Double.parseDouble(df.format(total_distance));
		setTitle("(eGEN) Track: " + currentTrackId + " Distance: " + Double.toString(total_distance) + "m" );
	}
